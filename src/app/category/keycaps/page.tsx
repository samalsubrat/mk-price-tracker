  ...
  React.useEffect(() => {
    async function fetchData() {
      ...
      const { data, error } = await supabase
        ...
        .or("category.ilike.%keycap%,category.ilike.%keyset%")
    ...
    <MaxWidthWrapper>
      <div className="w-full space-y-4 py-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          />
          <div className="text-sm text-muted-foreground">{table.getFilteredRowModel().rows.length} keycap(s) found</div>
        </div>
                  ...
                  <TableRow>
                    <TableCell colSpan={columns.length} className="text-center py-8">
                      <div className="flex items-center justify-center space-x-2">
                        ...
                        <span className="text-xs sm:text-sm">Loading keycaps...</span>
                      </div>
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    <TableCell colSpan={columns.length} className="text-center py-8">
                      <div className="flex flex-col items-center space-y-2">
                        <div className="text-muted-foreground text-xs sm:text-sm">No keycaps found.</div>
